        ...
        <div className='bg-transparent absolute p-4 w-full'>
            <div className='max-w-[1240px] items-center py-2 flex justify-between mx-auto'>
                ...
                >
                    ...
                    <motion.div className='h-[50px] border-x-2 border-white mx-2' variants={itemVariants} transition={{ duration: 0.5, delay: 0.5, ease: 'easeInOut', repeat: Infinity, repeatType: 'mirror', repeatDelay: 2, yoyo: false, }}></motion.div>
                    <motion.div className='content-center text-3xl text-white-100 font-bold' variants={solutionVariant} transition={{ duration: 0.5, delay: 0.5, ease: 'easeInOut', repeat: Infinity, repeatType: 'mirror', repeatDelay: 2, yoyo: false, }}>
                        SASKA Solution
                    </motion.div>
                </motion.div>
                {
