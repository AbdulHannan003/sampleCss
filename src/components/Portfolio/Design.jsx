...
//                         <img src={project.url} alt={project.alt} className='w-full h-full object-cover transition-transform duration-300 transform hover:scale-105' />
//                         <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
//                             <p className="text-white text-center font-semibold text-lg">Click to view</p>
//                         </div>
//                     </div>
//                 ))}
//             </div>
