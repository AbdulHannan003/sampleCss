...
const Design = () => {
    ...
    return (
        <div className='w-full bg-gradient-to-r from-[#662e9b] to-[#982aff] border border-[#662e9b]'>
            <div className="max-w-[1240px] text-center p-0 mx-auto md:my-10 md:flex">
                ...
                <div className=" text-center p-2 col-span-1 md:w-2/4">
                    <h1 className="text-center py-4 md:text-4xl text-xl font-bold text-white">
                        Have a look at our work for our customers
                    </h1>
                    <p className="text-center text-white py-4 md:text-lg">
            ...
            <div className="max-w-[1240px] mx-auto md:text-lg py-1 text-center md:py-3 flex justify-evenly">
                <button
                    ...
                    className='border-2 border-white mt-4 px-4 py-1 rounded-full text-white focus:bg-white focus:text-[#662b9e] focus:shadow-lg font-bold'
                >
                    Logo
                </button>
                <button
