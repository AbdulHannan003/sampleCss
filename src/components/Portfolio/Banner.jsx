...
function Banner() {
    ...
    return (
        <div style={divStyle} className="w-full content-center bg-cover bg-opacity-30 bg-no-repeat bg-center h-[90vh]">
            <div className='text-center font-bold'>
                ...
                <div className="text-white md:text-lg py-1 md:py-3 ">
                    <button className='border-2 border-primary mt-4 px-4 py-1 rounded-full text-primary hover:text-white hover:bg-primary duration-300'>Get Started</button>
                </div>
            </div>
        </div>
