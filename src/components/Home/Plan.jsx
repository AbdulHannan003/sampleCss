...
//                 <h1 className='text-white-100 text-xl md:text-5xl font-bold text-center'>Offering Plans</h1>
...
//                     <div key={index} className="flex flex-col sm:mx-2 h-auto rounded-xl px-4 pt-12 pb-2 bg-gradient-to-b from-[#662e9b] to-[#982aff] hover:scale-105 duration-500">
//                         <span className='text-sm font-semibold text-white-100'>Starting From</span>
...
//                             <h2 className='text-base md:text-xl py-2 font-bold text-white-100'>{item.title}</h2>
//                         </div>
//                         <div>
//                             <ul>
//                                 {Object.keys(item).map((key, index) => {
//                                     if (key === 'price' || key === 'title') return null
//                                     return item[key] && <li key={index} className='text-sm md:text-sm py-2 flex  items-center'>
...
//                         </div>
//                         <div className='px-4 pt-12 rounded-full text-white-100'>
