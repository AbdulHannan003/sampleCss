        ...
        <div className=' w-max-[1240px] h-auto'>
            <div className='w-max-[1024px] py-10 md:grid justify-around md:grid-cols-2'>
                ...
                <div className='p-4 mx-auto text-center col-span-1 w-3/4'>
                    ...
                    <button className=' border-2 mx-auto md:px-12 border-[#662e9b] mt-4 px-4 flex flex-row py-1 rounded-full text-[#662e9b] hover:text-white hover:bg-[#662e9b] duration-300 items-center'>Contact<span className='pl-2 text-2xl'><AiOutlinePhone /></span></button>
                </div>
            </div>
        </div >
    )
