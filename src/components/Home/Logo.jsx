...
const PortfolioItem = ({ src, alt, title, description, inView }) => (
    <motion.div initial="hidden" animate={inView ? "visible" : "hidden"} variants={fadeInUpVariants}>
        <div className='flex flex-col items-center p-4'>
            <div className='h-[200px] w-[300px] overflow-hidden rounded-lg shadow-lg'>
                <img src={src} alt={alt} className='w-full h-full object-cover transition-transform duration-300 transform hover:scale-105' />
            </div>
